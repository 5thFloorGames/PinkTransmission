// Code by grimmdev from: https://gist.github.com/grimmdev/979877fcdc943267e44c
...
public class Translate : MonoBehaviour
{
    ...
    public string sourceLang = "fi";
    public string sourceWord = "ovi";
    ...
    void Start()
    {
        ...
        if (isDebug)
            StartCoroutine(Process(sourceWord));
    }

    // We have use googles own api built into google Translator.
    public IEnumerator Process(string sourceText)
    {
